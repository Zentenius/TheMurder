export default function Conflict() {
    return (
          <section data-aos="fade-up" className='min-h-screen bg-gradient-to-r from-black to-[#313236] mt-0' style={{backgroundImage: `url("https://images.hindustantimes.com/img/2021/09/21/550x309/the_tragedy_of_macbeth_1632231689954_1632231690100.png") backgroundsize: cover`}}> 
            <h1 className='text-center pt-10 pb-10 text-5xl'>Conflics in the story</h1>
              <p className='mx-auto p-5 md:w-3/5 indent-8 m-auto text-gray-400 md:text-2xl'>
              ...
              <br/>
              <p className='mx-auto p-5 md:w-3/5 indent-8 text-gray-400 pb-10 md:text-2xl'>
              Other conflicts include the betrayal of Banquo and the Duncan (man vs man), Macbeth&apos;s fight against his conscience (man vs self), Macbeth having men kill Macduff&apos;s family (man vs man)
              </p>
            <h1 className='text-center pt-10 pb-10 text-5xl m-auto'>What is the purpose of the story</h1>
            <p className='mx-auto md:w-3/5 p-5 indent-8 text-gray-400 pb-10 md:text-2xl'>The main purpose of the story is to say that a man&apos;s ambition and greed may have many consequences that will haunt you for the rest of your lives</p>
